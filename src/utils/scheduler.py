...
class DDIMInverseScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.TOTAL_NUM_TIMESTEPS = num_train_timesteps
    ...
    def step(
        ...
        a_prev = alpha_t_prev = self.alphas_cumprod[prev_timestep-1] if prev_timestep <= self.TOTAL_NUM_TIMESTEPS else self.final_alpha_cumprod
